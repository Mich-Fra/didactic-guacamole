...
def salva_rotazione():
    ...
    try:
        ...
        #
        # selezionato     = "1"
        # non selezionato = valore hidden "0"
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # SALVA PROTEZIONE VENERDÌ → LUNEDÌ
        # ----------------------------------------------------
        ...
        # eliminiamo il tetto manuale.
        #
        # Il tetto torna quindi automatico.
        # ----------------------------------------------------
...
def salva_tetto():
    ...
    # --------------------------------------------------------
    # PERSONE/GIORNO → SETTIMANE
    # --------------------------------------------------------

    nuove_settimane = (
        settimane_da_persone_giorno(
            n_automatici,
            persone_giorno
        )
    )
    ...
    # --------------------------------------------------------
    # SALVA SETTIMANE CORRISPONDENTI
    # --------------------------------------------------------
